...
class VaksinCovid19Fragment : Fragment(), CoroutineScope, RecognitionListener {
    ...
    private fun textToSpeech() {
        ...
        val menu = getString(R.string.menu_vaksin19)
        ...
        textToSpeechEngine?.setOnUtteranceProgressListener(object : UtteranceProgressListener() {
            ...
            override fun onDone(utteranceId: String?) {
                ...
                val ttsLoop = utteranceId.equals("menu")
                        ...
                        || utteranceId.equals("menuJenisVaksin")
                if (ttsLoop) {
                    startListening()
                }
            }
    ...
    override fun onResults(results: Bundle?) {
        ...
        if (loopCode == 0) {
            when {
                check1 -> {
                    val vaksinCovid19 = getString(R.string.vaksin_covid19)
                    val menu = getString(R.string.menu_vaksin19)
                ...
                check2 -> {
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                    textToSpeechEngine?.speak(
                        menuJenisVaksin,
                        TextToSpeech.QUEUE_FLUSH,
                        null,
            ...
            when {
                check1 -> {
                    val option1 = getString(R.string.jenisVaksin1)
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                ...
                check2 -> {
                    val option2 = getString(R.string.jenisVaksin2)
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                ...
                check3 -> {
                    val option3 = getString(R.string.jenisVaksin3)
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                ...
                check4 -> {
                    val option4 = getString(R.string.jenisVaksin4)
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                ...
                check5 -> {
                    val option5 = getString(R.string.jenisVaksin5)
                    val menuJenisVaksin = getString(R.string.menu_jenisVaksin19)
                    textToSpeechEngine?.speak(option5, TextToSpeech.QUEUE_FLUSH, null, "option5")
                    textToSpeechEngine?.speak(
                        menuJenisVaksin,
                        TextToSpeech.QUEUE_ADD,
                        null,
    ...
    companion object {
        private const val TAG = "VaksinCovid19"
    }
}