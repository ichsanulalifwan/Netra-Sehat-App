...
import com.app.netrasehat.databinding.FragmentSembuhCovid19Binding
...
@AndroidEntryPoint
class SembuhCovid19Fragment : Fragment(), CoroutineScope, RecognitionListener {

    @Inject
    lateinit var prefs: DataStore<Preferences>
    private lateinit var speechRecognizer: SpeechRecognizer
    private lateinit var sttIntent: Intent
    private var _binding: FragmentSembuhCovid19Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSembuhCovid19Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun textToSpeech() {
        ...
        val menu = getString(R.string.menu_sembuhCovid19)
        ...
        textToSpeechEngine?.setOnUtteranceProgressListener(object : UtteranceProgressListener() {
            ...
            override fun onDone(utteranceId: String?) {
                ...
                val ttsLoop = utteranceId.equals("menu")
                        ...
                        || utteranceId.equals("menukriteriaSembuh")
                if (ttsLoop) {
                    startListening()
                }
            }
    ...
    override fun onResults(results: Bundle?) {
        ...
        if (loopCode == 0) {
            when {
                check1 -> {
                    val sembuhCovid19 = getString(R.string.sembuhdari_covid19)
                    val menu = getString(R.string.menu_sembuhCovid19)
                ...
                check2 -> {
                    val kriteriaSembuh = getString(R.string.menu_kriteriaSembuhCovid19)
                    textToSpeechEngine?.speak(
                        kriteriaSembuh,
                        TextToSpeech.QUEUE_FLUSH,
                        null,
            ...
            when {
                check1 -> {
                    val option1 = getString(R.string.kriteriasembuh1)
                    val menuKriteria = getString(R.string.menu_kriteriaSembuhCovid19)
                ...
                check2 -> {
                    val option2 = getString(R.string.kriteriasembuh2)
                    val menuKriteria = getString(R.string.menu_kriteriaSembuhCovid19)
                    textToSpeechEngine?.speak(option2, TextToSpeech.QUEUE_FLUSH, null, "option2")
                    textToSpeechEngine?.speak(
                        menuKriteria,
                        TextToSpeech.QUEUE_ADD,
                        null,
                ...
                check3 -> {
                    val option3 = getString(R.string.kriteriasembuh3)
                    val menuKriteria = getString(R.string.menu_kriteriaSembuhCovid19)
                    textToSpeechEngine?.speak(option3, TextToSpeech.QUEUE_FLUSH, null, "option3")
                    textToSpeechEngine?.speak(
                        menuKriteria,
                        TextToSpeech.QUEUE_ADD,
                        null,
                ...
                check4 -> {
                    val option4 = getString(R.string.kriteriasembuh4)
                    val menuKriteria = getString(R.string.menu_kriteriaSembuhCovid19)
                    textToSpeechEngine?.speak(option4, TextToSpeech.QUEUE_FLUSH, null, "option4")
                    textToSpeechEngine?.speak(
                        menuKriteria,
                        TextToSpeech.QUEUE_ADD,
                        null,
    ...
    companion object {
        private const val TAG = "SembuhCovid19"
    }
}